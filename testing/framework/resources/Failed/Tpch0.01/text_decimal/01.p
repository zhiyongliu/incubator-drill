{
  ...
  "graph" : [ {
    ...
    "exprs" : [ {
      ...
      "ref" : "`l_quantity`",
      "expr" : "cast( (`columns`[4] ) as DECIMAL18(15, 2) )"
    }, {
      "ref" : "`l_extendedprice`",
      "expr" : "cast( (`columns`[5] ) as DECIMAL18(15, 2) )"
    }, {
      "ref" : "`$f4`",
      "expr" : "multiply(cast( (`columns`[5] ) as DECIMAL18(15, 2) ), subtract(1, cast( (`columns`[6] ) as DECIMAL18(15, 2) )) ) "
    }, {
      "ref" : "`$f5`",
      "expr" : "multiply(multiply(cast( (`columns`[5] ) as DECIMAL18(15, 2) ), subtract(1, cast( (`columns`[6] ) as DECIMAL18(15, 2) )) ) , add(1, cast( (`columns`[7] ) as DECIMAL18(15, 2) )) ) "
    }, {
      "ref" : "`l_discount`",
